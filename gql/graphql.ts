...
export type MersPrimaryEstimatesQuery = { __typename?: 'Query', mersPrimaryEstimates: Array<{ __typename: 'MersPrimaryEstimate', id: string, estimateId: string, primaryEstimateInfo:
    ...
    , geographicalAreaSubestimates: Array<{ __typename: 'MersGeographicalAreaSubEstimate', id: string, estimateId: string, city?: string | null, state?: string | null, district?: string | null, country: string, countryAlphaTwoCode: string, countryAlphaThreeCode: string, latitude: number, longitude: number, whoRegion?: WhoRegion | null, unRegion?: UnRegion | null, geographicScope?: string | null, estimateInfo:
        | { __typename: 'MersSeroprevalenceSubEstimateInformation', sampleDenominator?: number | null, sampleNumerator?: number | null, seroprevalence: number, seroprevalence95CILower?: number | null, seroprevalence95CIUpper?: number | null, seroprevalenceCalculated95CILower?: number | null, seroprevalenceCalculated95CIUpper?: number | null }
        | { __typename: 'MersViralSubEstimateInformation', sampleDenominator?: number | null, sampleNumerator?: number | null, positivePrevalence: number, positivePrevalence95CILower?: number | null, positivePrevalence95CIUpper?: number | null, positivePrevalenceCalculated95CILower?: number | null, positivePrevalenceCalculated95CIUpper?: number | null }
