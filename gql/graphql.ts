...
export type MonthlySarsCov2CountryInformationQueryVariables = Exact<{ [key: string]: never; }>;


export type MonthlySarsCov2CountryInformationQuery = { __typename?: 'Query', monthlySarsCov2CountryInformation: Array<{ __typename?: 'MonthlySarsCov2CountryInformationEntry', population?: number | null, peopleVaccinatedPerHundred?: number | null, peopleFullyVaccinatedPerHundred?: number | null, positiveCasesPerMillionPeople?: number | null, alphaTwoCode: string, alphaThreeCode: string, month: Month, year: number, whoRegion?: WhoRegion | null, unRegion?: UnRegion | null, gbdSuperRegion?: GbdSuperRegion | null, gbdSubRegion?: GbdSubRegion | null }> };
