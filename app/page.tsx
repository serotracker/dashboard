            ...
            <div className="flex flex-col justify-between w-full rounded-md p-4 mb-4 h-1/2 text-background bg-white/90">
              <div className="w-full">
                ...
                <h3 className="rounded-md p-2">
                  Your Go to Source for COVID-19 and Arbovirus Seroprevalence
                  Data
                </h3>
                <div className="p-2 rounded-md">
                  <p className=" w-fit mb-2">
                    ...
                    analytics on the data and extract monthly insights relating
                    to tredns and patterns we find in the data
                  </p>
                  <p className=" w-fit mb-2">
                    We conduct an ongoing systematic review to track serosurveys
                    (antibody testing-based surveillance efforts) around the
                    world and visualize findings on this dashboard.
                  </p>
