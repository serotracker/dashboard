          ...
          <div className="w-full">
            ...
            <div className="p-2 rounded-md">
              <p className=" w-fit mb-2">
                ...
                seroprevalence studies worldwide, collect and standardize the
                data we extract from them, provide useful analytics on the data
                and extract monthly insights relating to tredns and patterns we
                find in the data
              </p>
              <p className=" w-fit mb-2">
