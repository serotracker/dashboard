  ...
  return (
    <div className="w-full h-fit relative row-span-2 rounded-md my-4 border border-background p-4 flex flex-col gap-4">
      ...
      <div className="flex justify-start items-center gap-6">
        <Link
          href="#TABLE"
          className="flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground px-4 py-2 w-[30%] bg-background hover:bg-backgroundHover h-full">
          Download CSV with Seroprevalence Estimates
        </Link>
        <Link
          href="/about/about-our-data"
          className="flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground px-4 py-2 w-[30%] bg-background hover:bg-backgroundHover ml-2 h-full">
          Cite our Data
        </Link>
      </div>
    </div>
