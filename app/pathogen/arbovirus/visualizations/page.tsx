...
import { GenericPathogenVisualizationsPage, VisualizationInformation } from "../../generic-pathogen-visualizations-page";
...
const arbovirusVisualizationInformationArray = typedObjectEntries(arbovirusVisualizationInformation).map(([_, value]) => value);
